...
public class MatchFingerInsert {
    ...
    public static void insertFinger(int pCustId, int pAgentId, String pAgentFP, String pCustFP, byte[] pFPdata, String pStatus) throws SQLException {
        ...
        try {
            ...
            String sql = "INSERT INTO BIOTPL.finger_match_report(AGENT_CUST_NO, CUSTOMER_CUST_NO, CREATE_DATE, CREATE_BY, AGENT_FINGER, CUSTOMER_FINGER, CUSTOMER_FINGER_DATA,  STANDARD, STATUS)\n"
                    + "                                   VALUES("+vAgentId+",   "+vCustId+",        sysdate,       NULL,    '"+vAgentFP+"',    '"+vCustFP+"',         null,   '"+vStandard+"', 'Y')"; //"+vFPdata+"
